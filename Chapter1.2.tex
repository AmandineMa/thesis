...
In this chapter, first in Section~\ref{chap2:sec:soc_inter}, we investigate what have been implemented in \acrshort{hri} in order to offer a frame to human-robot interactions as a supervisor has to handle such situations. Then, in Section~\ref{chap2:sec:hri_ja}, in the context of a collaborative work with philosophers and psychologists, we reviewed some elements of joint action and collaboration which had been implemented in robots.
