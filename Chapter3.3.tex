...
In their paper ``User Profiling and Behavioral Adaptation for HRI: A Survey'', \cite{rossi_2017_user} defined the two scopes for \acrshort{hri} as illustrated in Figure~\ref{fig:profiling}. 
